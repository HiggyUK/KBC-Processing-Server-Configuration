...
Module Script
	...
	Sub VisitParking_OnChange(ByVal eventData As ClientEventData)
		...
		Else
			...
			eventData.Form.Fields.GetField("VisitCarDetails").Value = ""
	...
	Sub Visitors_OnChange(ByVal eventData As ClientEventData)
		...
		If (File.Exists(vsSelected)) Then
			...
			Do 
				...
				If vsLine(0) = "DateOfVisit" Then vsDate = split(vsLine(1),"/")
			...
			eventData.Form.Fields.GetField("VisitDate").Value = vsDate(1) & "/" & vsDate(2) & "/" & vsDate(0)
